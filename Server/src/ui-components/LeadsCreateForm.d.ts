...
export declare type LeadsCreateFormInputValues = {
    f_name?: string;
    L_name?: string;
    Make?: string;
    Model?: string;
...
export declare type LeadsCreateFormValidationValues = {
...
export declare type LeadsCreateFormOverridesProps = {
    LeadsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type LeadsCreateFormProps = React.PropsWithChildren<{
    overrides?: LeadsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: LeadsCreateFormInputValues) => LeadsCreateFormInputValues;
    onSuccess?: (fields: LeadsCreateFormInputValues) => void;
    onError?: (fields: LeadsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: LeadsCreateFormInputValues) => LeadsCreateFormInputValues;
    onValidate?: LeadsCreateFormValidationValues;
} & React.CSSProperties>;
export default function LeadsCreateForm(props: LeadsCreateFormProps): React.ReactElement;
